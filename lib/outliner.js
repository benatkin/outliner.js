(function() {
  ...
  Outliner.MapModel = Outliner.Model.extend({
    ...
    initialize: function(attributes, options) {
      ...
      var children = _.map(attributes.value, function(childValue, childKey, value) {
      ...
      this.children = new Outliner.MapCollection(children, {resource: this.resource});
    }
  },
  {
    create: function(attributes, options) {
  ...
  Outliner.MapCollection = Outliner.Collection.extend({
    initialize: function(models, options) {
      ...
      this.naturalSort = this.resource.get('naturalSort');
      return Outliner.Collection.prototype.initialize.call(models, options);
    },
    comparator: function(model) {
      return model.get('key');
    },
    sortBy: function(comparator) {
      if (! this.naturalSort) return Outliner.Collection.prototype.sortBy.call(this, comparator);
    ...
    sortedIndex: function(model, comparator) {
      if (! this.naturalSort) return Outliner.Collection.prototype.sortedIndex.call(this, model, comparator);
